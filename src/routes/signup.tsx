    ...
    <div className="mx-auto flex min-h-screen w-full max-w-[440px] flex-col px-6 py-10">
      ...
      <div className="mb-6 flex flex-col items-center text-center animate-fade-up">
        <div className="relative mb-4 h-20 w-20">
          <div className="absolute inset-0 animate-orbit rounded-full border-2 border-accent/40" />
          <div className="absolute inset-2 animate-pulse-glow rounded-full bg-gradient-to-br from-accent to-primary" />
        </div>
