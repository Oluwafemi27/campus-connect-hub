...
const operators = [
  ...
  },
  {
    id: "glo",
    label: "Glo",
    logo: "https://upload.wikimedia.org/wikipedia/en/1/10/Globacom_2012_logo.png",
    bg: "bg-white",
  },
  {
    id: "9mobile",
    label: "9mobile",
    logo: "https://upload.wikimedia.org/wikipedia/en/9/90/9Mobile_2017_logo.png",
    bg: "bg-white",
  },
];
  ...
  return (
    <div className="space-y-4 animate-fade-up">
      ...
      <div className="glass space-y-4 rounded-2xl p-4">
        ...
        <button onClick={() => toast.success("Audit log opened")} className="tile-press flex w-full items-center gap-3 rounded-xl bg-muted/20 px-3 py-3 text-left transition-colors hover:bg-muted/30">
      ...
      <div className="glass space-y-4 rounded-2xl p-4">
        <p className="text-[10px] font-bold tracking-widest text-muted-foreground">MOBILE OPERATORS</p>
        <div className="space-y-3">
          {operators.map((op) => (
            <div key={op.id} className="flex items-center gap-3 rounded-lg bg-muted/10 p-3 transition-colors hover:bg-muted/20">
              <div className={`flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-lg p-2 ${op.bg}`}>
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-muted-foreground">{operatorStatus[op.id as keyof typeof operatorStatus] ? "Active" : "Disabled"}</p>
              </div>
              <Switch
